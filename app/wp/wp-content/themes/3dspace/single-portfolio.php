...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>    
	...
	<div class="top-image" style="background: url('<? echo get_post_meta($post->ID, 'main_image', true);?>')"></div>
	<? }else {?>
	<div class="top-image" style="background: url('<? bloginfo('stylesheet_directory');?>/pictures/slider/2_finish.jpg')"></div>
	<? } ?>
            ...
            <div class="columns large-12">
                <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1104px; height: 556px; background: #191919; overflow: hidden;">
					...
					<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:1104px; height: 456px; overflow: hidden;">
						...
						<div>
							<img u="image" src="<? echo "".get_post_meta($post->ID, 'main_image', true).""; ?>" />
